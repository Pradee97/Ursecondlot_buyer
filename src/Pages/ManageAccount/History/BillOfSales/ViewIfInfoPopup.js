...
const ViewIfInfoPopup = (props) => {
    ...
    const [comments,setComments] = useState(props.viewIfId);
    ...
    const saveAdd = () => {
        ...
        // props.addIF(recentlyAddednewvalue)
        setComments(" ")
                     ...
                     <div className="Commonfullformblock col-lg-9">
                        ...
                        (<>
                            <div className="CommonModalbody">
                                <h2 >View IF Info</h2>
                                <label for="buyer" className="form-label required">IF Info</label>
                                <textarea className="form-control mt-3" type="text" placeholder=""
                                    aria-label="default input example" value = {comments} onChange={(e) => setComments(e.target.value)}/>
...
<div className="CommonModalfooter ">
                            <div className="CommonModalfooter session">
                                ...
                                {/* <Button className="btn btn-smlprimary" onClick={saveAdd} >Ok</Button>  */}
                            </div> 
                            </div>    
</>):""}        
...
export default ViewIfInfoPopup