...
const ViewTitlePopup = (props) => {
    ...
    const [comments,setComments] = useState(props.titleId);
                     ...
                     <div className="Commonfullformblock col-lg-9">
                        ...
                        (<>
                            <div className="CommonModalbody">
                                <h2 >View Enter Title</h2>
                                <label for="buyer" className="form-label required">Title #</label>
