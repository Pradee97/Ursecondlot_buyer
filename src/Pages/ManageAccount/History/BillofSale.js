...
const BillofSale = (props) => {
  ...
  return (
      ...
      <div className='col-sm-12'>
                                ...
                                <div class="col-md-6 col-lg-4  form-group"><div class="tbox"><input type="text" class="textbox" placeholder=""  defaultValue={BOSList?.seller_dealer_name} disabled/><label for="Gate_Pass#" class="input-has-value">Seller #</label></div></div>
                                ...
                                <div class="col-md-6 col-lg-4  form-group"><div class="tbox"><input type="text" class="textbox" placeholder=""  defaultValue={BOSList?.buyer_dealer_name} disabled/><label for="Gate_Pass#" class="input-has-value">Buyer #</label></div></div>
                                ...
                                <div class="col-md-6 col-lg-4  form-group"><div class="tbox"><input type="text" class="textbox" placeholder=""  defaultValue={BOSList?.carprice} disabled/><label for="Gate_Pass#" class="input-has-value">Bid Price</label></div></div>
                                ...
                                <div class="col-md-6 col-lg-4  form-group"><div class="tbox"><input type="text" class="textbox" placeholder=""  defaultValue={BOSList?.sale_tax} disabled/><label for="Gate_Pass#" class="input-has-value">Sale Tax</label></div></div>
                                <div class="col-md-6 col-lg-4  form-group"><div class="tbox"><input type="text" class="textbox" placeholder=""  defaultValue={BOSList?.county_tax} disabled/><label for="Gate_Pass#" class="input-has-value">Country Tax</label></div></div>
                                <div class="col-md-6 col-lg-4  form-group"><div class="tbox"><input type="text" class="textbox" placeholder=""  defaultValue={BOSList?.city_tax} disabled/><label for="Gate_Pass#" class="input-has-value">City Tax</label></div></div>
