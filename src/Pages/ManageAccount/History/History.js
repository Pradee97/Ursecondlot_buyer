...
import ReactExport from "react-data-export";
 ...
 const History = () => {
  ...
  const redirecttoInspection=(pathid)=>{
    ...
    const redirecttoInvoice=(car_id,seller_dealer_id,price,lot_fee,bill_of_sale_code,gatepass_id,sold_date,make,model,year,transportation_charge,transportation,inventory_no,vin_no,late_fee, car_payment_date,payment_mode,company_name)=>{
      //   history.push("/Inspection/"+pathid);
      history.push({
        pathname: "/Invoice",
        state: {car_id,sellerDealerID:seller_dealer_id,vechileprice:price,lotFee:lot_fee,billOfSales:bill_of_sale_code,gatePassId:gatepass_id,Date:sold_date,Make:make,Model:model,Year:year,transportationCharge:transportation_charge,Transportation:transportation,invNo:inventory_no,vinNo:vin_no,LateFee:late_fee, BillOfSaleDate:car_payment_date, PaymentMode:payment_mode,CompanyName:company_name}

        });
        console.log ("hi",price,lot_fee,bill_of_sale_code,gatepass_id,sold_date);
      }
          ...
          setCarDetailForExcel(response.data.data.map(value=> {
            return {
              ...
              inventory_no:  value.inventory_no,
                bill_of_sale_code:    value.bill_of_sale_code,
...
const togglePrint = () => {
  ...
  const PrintData = (historyDetail) =>{
      ...
      setbillOfSales(historyDetail.bill_of_sale_code);
            ...
            <div class="downloadBtn">
             ...
             <ExcelFile>
                <ExcelSheet data={carDetailForExcel} name="URCar">
                    ...
                    <ExcelColumn label="BOS #" value="bill_of_sale_code"/>     
          ...
          <div class="lotfee-inner col-lg-12 toggleExpand">
                <div class="row">							
                  <div class="col-lg-4">
                    ...
                    <div class="car-item">
                    <div class="pickupdetailcontent">
                      <p class="billsalesno">Bill Of sale #{historyDetail.bill_of_sale_code}</p>
                    </div>
                  ...
                  <div class="col-lg-4 priceBlock">
                    ...
                    <div class="vehicleimgright col-lg-12">
                      <p class="editbtn m-0"><a class="" href="JavaScript:void(0)" onClick={()=>HistoryEdit(`transporationDiv${historyDetail.car_id}`,`transporationHeader${historyDetail.car_id}`)}>{historyDetail.bill_of_sale_code !== null && historyDetail.bill_of_sale_code !== "" ? "": "Edit Transportation" }</a></p>
                    ...
                    <a class={`cta-btns-primary ${(historyDetail.bill_of_sale_code !== null && historyDetail.bill_of_sale_code !== ""  ) && "greenBtn"}`} onClick={()=>{(historyDetail.bill_of_sale_code == null || historyDetail.bill_of_sale_code == ""  )&& redirecttoCart()}}  >{historyDetail.bill_of_sale_code !== null && historyDetail.bill_of_sale_code !== "" ? "paid": "pay" }  </a>   
                            ...
                            <table   >
                                    <thead>
                                      <tr>
                                        ...
                                        <td>{historyDetail.bill_of_sale_code}</td>
