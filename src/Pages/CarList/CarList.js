...
const CarList = () => {
  ...
  const getSuggestedCarList = () => {
    ...
    API.post("SuggestedCarList/condition", request)
      .then((res) => {
        ...
        <main id="main" className="inner-page carList carouselPage">
          <div id="suggested-cars" className="suggested-cars">
            ...
            >
              ...
              <OwlCarousel
                className="owl-theme row aos-init aos-animate"
                data-aos="zoom-in"
                data-aos-delay="100"
                loop={suggestedCarDetail?.length > 4 ? true : false}
                margin={10}
                items={4}
                dots={false}
                nav
              ...
              >
                {suggestedCarDetail?.length > 0
                  ? suggestedCarDetail.map((item) => (
                      <div>
                        <div className="car-item">
                          ...
                          <img
                            ...
                            src={item.image}
                            onClick={() => {
                              redirectpage(item.car_id, item.seller_dealer_id);
                            }}
                          />
                          {item.isbestSale ? (
                          ...
                          <div className="cars-content">
                            <h3>
                              <a
                                ...
                                title={`${item.make} (${item.model}) model`}
                              >
              ...
              {suggestedCarDetail.length > 4
                ? suggestedCarDetail.slice(0, 1).map(() => (
                    <div className="text-center">
                      <a href="/suggestedcars" className="more-btn">
          ...
          <div id="inventory-cars" className="inventory-cars">
            ...
            >
              ...
              <OwlCarousel
                ...
                data-aos="zoom-in"
                data-aos-delay="100"
                loop={carInventoryDetail?.length > 4 ? true : false}
                margin={10}
                items={4}
                dots={false}
                nav
              ...
              >
                {carInventoryDetail?.length > 0
                  ? carInventoryDetail.map((item) => (
                      <div>
                        <div className="car-item">
                          <div className="cars-lock">
              ...
              {carInventoryDetail.length > 4
                ? carInventoryDetail.slice(0, 1).map(() => (
                    <div className="text-center">
                      <a href="/InventoryCars" className="more-btn">
                        View More<i className="bx bx-chevron-right"></i>
                      </a>
                    </div>
                  ))
          ...
          <div id="recently-cars" className="recently-cars">
            ...
            >
              ...
              <OwlCarousel
                ...
                data-aos="zoom-in"
                data-aos-delay="100"
                loop={carDetail?.length > 4 ? true : false}
                margin={10}
                items={4}
                dots={false}
                nav
              ...
              {carDetail.length > 4
                ? carDetail.slice(0, 1).map(() => (
                    <div className="text-center">
                      <a href="/recentlyAddedCars" className="more-btn">
                        View More<i className="bx bx-chevron-right"></i>
                      </a>
                    </div>
                  ))
          ...
          <div id="favorite-cars" className="recently-cars">
            ...
            >
              ...
              <OwlCarousel
                ...
                data-aos="zoom-in"
                data-aos-delay="100"
                loop={carFavInventoryDetail.length > 4 ? true : false}
                margin={10}
                items={4}
                dots={false}
                nav
              ...
              >
                {carFavInventoryDetail.length > 0
                  ? carFavInventoryDetail.map((item) => (
                      <div>
                        <div className="car-item">
                          <div className="cars-lock">
                            <img
              ...
              {carFavInventoryDetail.length > 4
                ? carFavInventoryDetail.slice(0, 1).map(() => (
                    <div className="text-center">
                      <a href="/favorite" className="more-btn">
                        View More<i className="bx bx-chevron-right"></i>
                      </a>
                    </div>
                  ))
