...
const PrivacyPolicyFiles = () => {
    ...
    return(
        <div>
        <main id="main" className="inner-page privacyPolicyPage">
...
<div className="aboutblock col-lg-12">
 ...
 <div className="row content">
   ...
   <div className="col-lg-12 pt-4 pt-lg-0">
     <p>
     <h4>CONSUMER PRIVACY STATEMENT</h4>
...
<h4>WHERE WE GET INFORMATION ABOUT YOU</h4>
The information we get about you comes from different sources and may include:


<ul>
        <li>Representations you make to us, such as your employment history, account balances, payment histories and your relationships with other persons or entities you have listed as references.
</li>
        <li>Representations you make to us, such as your employment history, account balances, payment histories and your relationships with other persons or entities you have listed as references.
</li>
        <li>Information from your transactions with us, our affiliated companies or our business partners who may provide you other related services.
</li>
        <li>Information we receive from consumer credit reporting agencies to confirm, verify or add to facts you provide us on applications or other forms. Data collected by such a reporting agency may be kept by them and later shared with others who are entitled to use these reports. That personal information gathered by consumer credit reporting agencies will be provided to others only as allowed by federal and state Fair Credit reporting laws.
</li>
        <li>Information we receive from your insurance agent or broker to confirm the presence of applicable insurance coverages required under an installment payment agreement.
</li>
...
<h4>OUR DEALERSHIP DOES NOT SELL OR RENT INFORMATION ABOUT YOU TO OTHERS.</h4>
...
<h4>HOW WE PROTECT ANY NON-PUBLIC PERSONAL INFORMATION WE COLLECT ABOUT YOU.</h4>

We maintain physical, administrative, procedural and technical safeguards to protect this personal information from unauthorized access. <br></br><br></br>
...
export default PrivacyPolicyFiles;